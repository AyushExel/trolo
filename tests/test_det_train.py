...
def dummy_dataset():
    ...
    dataset_path = create_dummy_coco_dataset(root_dir="./data/dummy_coco", num_images=10, num_objects_per_image=3)
    return dataset_path
...
def test_validation_only(dummy_dataset):
    ...
    trainer = DetectionTrainer(config="dfine_n_coco_dummy")
