...
For detailed help:  
```bash  
trolo --help # for general helptrolo [command] --help # for command-specific help```  
...
Python API:  
```python  
from trolo.inference import ModelExporter  
model_path = "/path/to/model"
input_size = 640 # Inference resolution
export_format = "onnx"
exporter = ModelExporter(model=model_path)  
...
Contributions are most welcome! Please feel free to submit a Pull Request. Please check issues for any open tasks.
