...
class ELAN(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, n=2, bias=False, act="silu", bottletype=VGGBlock):
        ...
        self.cv2 = nn.Sequential(
            bottletype(c3 // 2, c4, act=get_activation(act)), ConvNormLayer_fuse(c4, c4, 3, 1, bias=bias, act=act)
        )
        self.cv3 = nn.Sequential(
            bottletype(c4, c4, act=get_activation(act)), ConvNormLayer_fuse(c4, c4, 3, 1, bias=bias, act=act)
        )
